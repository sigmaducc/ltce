      ...
      <div className="flex flex-col items-center md:flex-row md:items-start justify-between">
        <div className="w-72 mr-4 md:w-56 md: pb-10">
          <div className="p-2 border text-center rounded-t-lg text-xl text-gray-900 bg-[#013b75] font-bold text-[#f7c653]">
            <div>Advances in Mechanical Engineering</div>
          </div>
          <div className="pt-4 pb-2 px-4 border rounded-b-lg text-base">
            <div className="py-2">Manufacturing Technologies</div>
            <div className="line" />
            <div className="py-2">Automation and Robotics</div>
            <div className="line" />
            <div className="py-2">Heat and Mass Transfer</div>
            <div className="line" />
            <div className="py-2">IC Engines and Electrical Vehicles</div>
            <div className="line" />
            <div className="py-2">Sustainable Manufacturing</div>
            <div className="line" />
            <div className="py-2">Logistics and Supply Chain Management</div>
            <div className="line" />
            <div className="py-2">CRM and ERP</div>
            <div className="line" />
            <div className="py-2">Nano Technologies</div>
            <div className="line" />
            <div className="py-2">Smart Materials</div>
            <div className="line" />
            <div className="py-2">MEMS</div>
            <div className="line" />
            <div className="py-2">Renewable and Non-Renewable Energy</div>
            <div className="line" />
            <div className="py-2">Non-Destructive Testing</div>
            <div className="line" />
            <div className="py-2">Composites</div>
            <div className="line" />
            <div className="py-2">Additive Manufacturing</div>
            <div className="line" />
            <div className="py-2">Computational Fluid Dynamics</div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-start md:flex-col ">
          <div className="w-72 mr-4 md:w-56 md: pb-10">
            <div className="p-2 border text-center rounded-t-lg text-xl text-gray-900 bg-[#013b75] font-bold text-[#f7c653]">
          ...
          <div className="w-72 md:w-56 pb-10">
            <div className="p-2 border text-center rounded-t-lg text-xl text-gray-900 bg-[#013b75] font-bold text-[#f7c653]">
          ...
          <div className="w-72 md:w-56">
            <div className="p-2 border text-center rounded-t-lg text-xl text-gray-900 bg-[#013b75] font-bold text-[#f7c653]">
              <div>IOT Application in Electrical System</div>
            </div>
            <div className="pt-4 pb-2 px-4 border rounded-b-lg text-base">
              <div className="py-2">Electric Vehicles</div>
              <div className="line" />
              <div className="py-2">Micro-Grid/Smart Grid</div>
              <div className="line" />
              <div className="py-2">Renewable Energy Sources</div>
              <div className="line" />
              <div className="py-2">Drives and Control</div>
              <div className="line" />
              <div className="py-2">Power Electronics</div>
            </div>
          </div>
        </div>
      </div>
